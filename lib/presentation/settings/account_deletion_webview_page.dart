...
class AccountDeletionWebViewPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AccountDeletionWebViewPage> createState() =>
      _AccountDeletionWebViewPageState();
}

class _AccountDeletionWebViewPageState
    extends ConsumerState<AccountDeletionWebViewPage> {
